        ...
        <div className="mb-6 flex gap-2">
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition ${
              tab === "gallery" ? "bg-forest text-cream" : "bg-white text-forest-deep hover:bg-cream-deep"
            }`}
          >
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition ${
              tab === "events" ? "bg-forest text-cream" : "bg-white text-forest-deep hover:bg-cream-deep"
            }`}
          >
