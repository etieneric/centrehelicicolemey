...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Centre Hélicicole Meye — Héliciculture d'excellence" },
      { property: "og:description", content: "Pionnier de l'élevage d'escargots géants au Cameroun. Formations, produits et pharmacopée traditionnelle à Yaoundé." },
